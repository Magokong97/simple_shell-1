 ...
 * @info: this struct containing potential arguments.then maintain constant function prototype.
 * Return: Always 0
 */
...
/**
 * _getenv - get the value of an environ variables
...
/**
 * _mysetenv -  its initialize a new environment variable,
...
/**
 * _myunsetenv -  its remove an environment variable
